...
const Index = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0B0F19] via-[#101623] to-[#0B0F19] font-poppins">
      {/* Header/Navigation */}
      <header className="container mx-auto px-6 py-8">
        <nav className="flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8">
            <a href="#servicios" className="text-gray-300 hover:text-[#FF4ECD] transition-colors font-medium">Servicios</a>
            <a href="#enfoque" className="text-gray-300 hover:text-[#FF4ECD] transition-colors font-medium">Enfoque</a>
            <a href="#sectores" className="text-gray-300 hover:text-[#FF4ECD] transition-colors font-medium">Sectores</a>
          </div>
          <Button className="bg-gradient-to-r from-[#0070F3] via-[#9B5DE5] to-[#FF4ECD] hover:from-[#FF4ECD] hover:via-[#9B5DE5] hover:to-[#0070F3] text-white font-bold shadow-lg shadow-[#9B5DE5]/25 hover:shadow-xl hover:shadow-[#FF4ECD]/30 transition-all duration-300 transform hover:scale-105">
            Agendar llamada
          </Button>
        </nav>
      </header>
      ...
      <section className="container mx-auto px-6 py-20 text-center">
        <div className="max-w-4xl mx-auto animate-fade-in">
          <h1 className="text-5xl md:text-6xl font-black text-[#F5F2E9] mb-8 leading-tight">
            Construimos ecosistemas inteligentes, no solo flujos automatizados.
          </h1>
          <p className="text-xl text-[#EAEAEA] mb-10 max-w-3xl mx-auto leading-relaxed font-medium">
          ...
          <Button 
            size="lg" 
            className="bg-gradient-to-r from-[#0070F3] via-[#9B5DE5] to-[#FF4ECD] hover:from-[#FF4ECD] hover:via-[#9B5DE5] hover:to-[#0070F3] text-white font-bold px-8 py-4 text-lg shadow-lg shadow-[#9B5DE5]/25 hover:shadow-xl hover:shadow-[#FF4ECD]/30 transition-all duration-300 transform hover:scale-105"
          >
      ...
      <section className="bg-gradient-to-r from-[#1A1F2E]/50 to-[#0B0F19]/30 backdrop-blur-sm py-20 shadow-lg border-t border-[#9B5DE5]/10">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center animate-slide-in">
            <p className="text-xl text-[#F5F2E9] mb-8 font-semibold">
              Sabemos que la IA no funciona en el vacío. Automatizar sin datos ni estructura solo genera ruido.
            </p>
            <p className="text-lg text-[#EAEAEA] mb-12 font-medium">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="text-center group bg-gradient-to-br from-[#1A1F2E] to-[#101623] p-6 rounded-xl hover:shadow-lg hover:shadow-[#0070F3]/10 transition-all duration-300 border border-[#9B5DE5]/20">
                ...
                <h3 className="font-bold text-[#F5F2E9] mb-2">Software a la medida</h3>
              </div>
              ...
              <div className="text-center group bg-gradient-to-br from-[#1A1F2E] to-[#101623] p-6 rounded-xl hover:shadow-lg hover:shadow-[#9B5DE5]/10 transition-all duration-300 border border-[#9B5DE5]/20">
                ...
                <h3 className="font-bold text-[#F5F2E9] mb-2">Modelos de IA aplicados</h3>
              </div>
              ...
              <div className="text-center group bg-gradient-to-br from-[#1A1F2E] to-[#101623] p-6 rounded-xl hover:shadow-lg hover:shadow-[#0070F3]/10 transition-all duration-300 border border-[#9B5DE5]/20">
                ...
                <h3 className="font-bold text-[#F5F2E9] mb-2">Infraestructura interoperable</h3>
              </div>
              ...
              <div className="text-center group bg-gradient-to-br from-[#1A1F2E] to-[#101623] p-6 rounded-xl hover:shadow-lg hover:shadow-[#FF4ECD]/10 transition-all duration-300 border border-[#9B5DE5]/20">
                ...
                <h3 className="font-bold text-[#F5F2E9] mb-2">Ecosistemas conectados</h3>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="servicios" className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-black text-[#F5F2E9] text-center mb-12">¿Qué hacemos?</h2>
            <p className="text-xl text-center text-[#EAEAEA] mb-12 font-medium">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-br from-[#1A1F2E] to-[#101623] p-8 rounded-xl shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-[#0070F3]/5 transition-all duration-300 border border-[#9B5DE5]/20">
                ...
                <h3 className="text-xl font-bold text-[#F5F2E9] mb-3">Entienden el lenguaje del negocio</h3>
                <p className="text-[#EAEAEA] font-medium">Desarrollamos soluciones que comprenden y se adaptan a la terminología y procesos específicos de tu industria.</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1A1F2E] to-[#101623] p-8 rounded-xl shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-[#9B5DE5]/5 transition-all duration-300 border border-[#9B5DE5]/20">
                ...
                <h3 className="text-xl font-bold text-[#F5F2E9] mb-3">Se integran con tus sistemas reales</h3>
                <p className="text-[#EAEAEA] font-medium">Creamos capas de integración robustas que conectan sin fricciones con tu infraestructura existente.</p>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#1A1F2E] to-[#101623] p-8 rounded-xl shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-[#FF4ECD]/5 transition-all duration-300 border border-[#9B5DE5]/20">
                ...
                <h3 className="text-xl font-bold text-[#F5F2E9] mb-3">Usan datos propietarios, no plantillas genéricas</h3>
                <p className="text-[#EAEAEA] font-medium">Aprovechamos tus datos únicos para entrenar modelos específicos que generen valor real para tu organización.</p>
              </div>
              
              <div className="bg-gradient-to-br from-[#1A1F2E] to-[#101623] p-8 rounded-xl shadow-lg shadow-black/10 hover:shadow-xl hover:shadow-[#0070F3]/5 transition-all duration-300 border border-[#9B5DE5]/20">
                <ArrowRight className="h-12 w-12 text-[#0070F3] mb-4" />
                <h3 className="text-xl font-bold text-[#F5F2E9] mb-3">Escalan contigo, no contra ti</h3>
                <p className="text-[#EAEAEA] font-medium">Arquitecturas modulares y flexibles que crecen con tu negocio sin generar complejidad innecesaria.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section id="enfoque" className="bg-gradient-to-r from-[#1A1F2E]/50 to-[#101623]/30 backdrop-blur-sm py-20 shadow-lg border-t border-[#9B5DE5]/10">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-black text-[#F5F2E9] text-center mb-16">Nuestro enfoque</h2>
            ...
            <div className="space-y-12">
              <div className="flex items-start space-x-6 p-6 rounded-xl hover:bg-gradient-to-r hover:from-[#1A1F2E]/30 hover:to-[#101623]/20 transition-all duration-300 border border-transparent hover:border-[#0070F3]/20">
                <div className="w-12 h-12 bg-gradient-to-br from-[#0070F3] to-[#9B5DE5] rounded-full flex items-center justify-center text-white font-black text-xl flex-shrink-0 shadow-lg shadow-[#0070F3]/30">
                  1
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#F5F2E9] mb-3">Diagnóstico con foco en datos y contexto</h3>
                  <p className="text-[#EAEAEA] font-medium">Analizamos profundamente tu ecosistema de datos, procesos existentes y objetivos estratégicos antes de proponer cualquier solución.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6 p-6 rounded-xl hover:bg-gradient-to-r hover:from-[#1A1F2E]/30 hover:to-[#101623]/20 transition-all duration-300 border border-transparent hover:border-[#9B5DE5]/20">
                <div className="w-12 h-12 bg-gradient-to-br from-[#9B5DE5] to-[#FF4ECD] rounded-full flex items-center justify-center text-white font-black text-xl flex-shrink-0 shadow-lg shadow-[#9B5DE5]/30">
                  2
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#F5F2E9] mb-3">Arquitectura modular y ágil</h3>
                  <p className="text-[#EAEAEA] font-medium">Diseñamos sistemas que pueden evolucionar y adaptarse, con componentes intercambiables y actualizables según cambien tus necesidades.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6 p-6 rounded-xl hover:bg-gradient-to-r hover:from-[#1A1F2E]/30 hover:to-[#101623]/20 transition-all duration-300 border border-transparent hover:border-[#FF4ECD]/20">
                <div className="w-12 h-12 bg-gradient-to-br from-[#FF4ECD] to-[#0070F3] rounded-full flex items-center justify-center text-white font-black text-xl flex-shrink-0 shadow-lg shadow-[#FF4ECD]/30">
                  3
                </div>
                <div>
                  <h3 className="text-xl font-bold text-[#F5F2E9] mb-3">IA integrada en capas, no como parche</h3>
                  <p className="text-[#EAEAEA] font-medium">La inteligencia artificial se incorpora desde el diseño arquitectónico, no como una solución superficial añadida posteriormente.</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-6 p-6 rounded-xl hover:bg-gradient-to-r hover:from-[#1A1F2E]/30 hover:to-[#101623]/20 transition-all duration-300 border border-transparent hover:border-[#0070F3]/20">
                ...
                <div>
                  <h3 className="text-xl font-bold text-[#F5F2E9] mb-3">Entrenamiento continuo y mejora real</h3>
                  <p className="text-[#EAEAEA] font-medium">Implementamos ciclos de aprendizaje que permiten que tu sistema mejore constantemente con cada interacción y nuevo dato.</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-3xl font-black text-[#F5F2E9] text-center mb-16">Cómo construimos ecosistemas inteligentes</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-[#9B5DE5]/20 to-[#FF4ECD]/20 p-8 rounded-xl border border-[#9B5DE5]/30 backdrop-blur-sm transform hover:scale-105 transition-all duration-300 shadow-lg shadow-[#9B5DE5]/10">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <h3 className="text-xl font-bold text-[#F5F2E9]">Aplicación Inteligente</h3>
                    </div>
                    <p className="text-[#EAEAEA] text-sm font-medium">Interfaces que toman decisiones automatizadas basadas en tu contexto específico</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-[#0070F3]/20 to-[#9B5DE5]/20 p-8 rounded-xl border border-[#0070F3]/30 backdrop-blur-sm transform hover:scale-105 transition-all duration-300 shadow-lg shadow-[#0070F3]/10 ml-8">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <h3 className="text-xl font-bold text-[#F5F2E9]">Modelos de IA Entrenados</h3>
                    </div>
                    <p className="text-[#EAEAEA] text-sm font-medium">Algoritmos especializados que aprenden el lenguaje de tu industria</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-[#FF4ECD]/20 to-[#0070F3]/20 p-8 rounded-xl border border-[#FF4ECD]/30 backdrop-blur-sm transform hover:scale-105 transition-all duration-300 shadow-lg shadow-[#FF4ECD]/10 ml-16">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <h3 className="text-xl font-bold text-[#F5F2E9]">Software a Medida</h3>
                    </div>
                    <p className="text-[#EAEAEA] text-sm font-medium">Arquitectura robusta que conecta con tus sistemas existentes</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-[#1A1F2E] to-[#101623] p-8 rounded-xl border border-[#9B5DE5]/50 backdrop-blur-sm transform hover:scale-105 transition-all duration-300 shadow-lg shadow-black/20 ml-24">
                    <div className="flex items-center space-x-4 mb-4">
                      ...
                      <h3 className="text-xl font-bold text-[#F5F2E9]">Datos del Negocio</h3>
                    </div>
                    <p className="text-[#EAEAEA] text-sm font-medium">Tu información propietaria, procesos únicos y conocimiento especializado</p>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                <div className="text-center">
                  <h3 className="text-2xl font-bold text-[#F5F2E9] mb-6">Flujo de construcción</h3>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-center space-x-4 p-6 bg-gradient-to-r from-[#1A1F2E]/30 to-[#101623]/20 rounded-xl border border-[#9B5DE5]/30 hover:border-[#0070F3]/30 transition-all duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-[#F5F2E9]">Datos del negocio</h4>
                      <p className="text-sm text-[#EAEAEA] font-medium">Analizamos y estructuramos tu información</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-6 bg-gradient-to-r from-[#1A1F2E]/30 to-[#101623]/20 rounded-xl border border-[#9B5DE5]/30 hover:border-[#FF4ECD]/30 transition-all duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-[#F5F2E9]">Software a medida</h4>
                      <p className="text-sm text-[#EAEAEA] font-medium">Creamos la infraestructura personalizada</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-6 bg-gradient-to-r from-[#1A1F2E]/30 to-[#101623]/20 rounded-xl border border-[#9B5DE5]/30 hover:border-[#0070F3]/30 transition-all duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-[#F5F2E9]">Modelos de IA entrenados</h4>
                      <p className="text-sm text-[#EAEAEA] font-medium">Integramos IA específica para tu contexto</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-4 p-6 bg-gradient-to-r from-[#9B5DE5]/20 to-[#FF4ECD]/20 rounded-xl border border-[#9B5DE5]/30 hover:border-[#9B5DE5]/50 transition-all duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-[#F5F2E9]">Decisiones inteligentes</h4>
                      <p className="text-sm text-[#EAEAEA] font-medium">Sistema que evoluciona y mejora continuamente</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section id="sectores" className="py-20">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-black text-[#F5F2E9] mb-8">Sectores donde aplicamos IA</h2>
            <div className="bg-gradient-to-br from-[#1A1F2E] to-[#101623] rounded-2xl p-12 shadow-xl shadow-black/20 border border-[#9B5DE5]/30">
              ...
              <p className="text-lg text-[#EAEAEA] leading-relaxed font-semibold">
      ...
      <section className="bg-gradient-to-r from-[#0B0F19] via-[#1A1F2E] to-[#0B0F19] py-20 border-t border-[#9B5DE5]/10">
        <div className="container mx-auto px-6 text-center">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl font-black text-[#F5F2E9] mb-6">¿Tienes un reto donde la IA sola no basta?</h2>
            <p className="text-xl text-[#EAEAEA] mb-10 font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="border-2 border-[#FF4ECD] text-[#FF4ECD] hover:bg-[#FF4ECD] hover:text-white px-8 py-4 text-lg shadow-lg shadow-[#FF4ECD]/10 hover:shadow-xl hover:shadow-[#FF4ECD]/20 transition-all duration-300 transform hover:scale-105 bg-transparent font-bold"
              >
      ...
      <footer className="bg-gradient-to-r from-[#0A0A0A] to-[#0D1117] py-12 shadow-inner border-t border-[#9B5DE5]/20">
        <div className="container mx-auto px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="text-2xl font-black text-[#F5F2E9] mb-6">Better Code</div>
